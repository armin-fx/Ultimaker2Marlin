...
static void lcd_menu_first_run_bed_level_paper_right()
{
    ...
    if (IS_FIRST_RUN_DONE())
    {
        lcd_info_screen(NULL, lcd_menu_first_run_bed_level_store, MSGP_MENU_DONE);
    }
    else
    {
        lcd_info_screen(lcd_menu_first_run_material_load, lcd_menu_first_run_bed_level_done, MSGP_MENU_CONTINUE);
    }
...
{
    SELECT_MAIN_MENU_ITEM(0);
    lcd_info_screen(lcd_menu_first_run_material_select_1, parkHeadForHeating, MSGP_MENU_CONTINUE);
    DRAW_PROGRESS_NR(11);
...
static void lcd_menu_first_run_material_load_wait()
{
    ...
    lcd_info_screen(lcd_menu_first_run_print_1, doCooldown, MSGP_MENU_CONTINUE);
    DRAW_PROGRESS_NR(19);
