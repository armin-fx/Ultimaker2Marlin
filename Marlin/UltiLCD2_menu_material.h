...
PartitionBase:      0x03FC-0x03FE 0x03
...
moveable EEPROM places (preferred location):
                    Location      Size
PartitionVector:    0x0480
armin_fx settings:  0x0500-
...
#define EEPROM_MATERIAL_SETTINGS_REAL_COUNT (EEPROM_MATERIAL_SETTINGS_MAX_COUNT + 2)
...
// bed temperature first layer vector
#define EEPROM_PARTITION_MATERIAL_BED_TEMPERATURE_FIRST_LAYER_NUMBER            1
#define EEPROM_PARTITION_MATERIAL_BED_TEMPERATURE_FIRST_LAYER_ADDRESS_PREFERRED 0x9C0
#define EEPROM_PARTITION_MATERIAL_BED_TEMPERATURE_FIRST_LAYER_SIZE_PREFERRED    (EEPROM_MATERIAL_SETTINGS_REAL_COUNT * 2)
//
#define EEPROM_MATERIAL_BED_TEMPERATURE_FIRST_LAYER(n) ((uint16_t*)(eeprom_partition.get_address_type(EEPROM_PARTITION_MATERIAL_BED_TEMPERATURE_FIRST_LAYER_NUMBER, 2 * uint16_t(n))))
