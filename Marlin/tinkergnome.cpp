...
static void drawBabystepSubmenu(uint8_t nr, uint8_t &flags)
{
    ...
    else if (nr == index++)
    {
        ...
        float_to_string2(FLOAT_SETTING(X_AXIS), buffer, MSGP_UNIT_MM, true);
    ...
    else if (nr == index++)
    {
        ...
        float_to_string2(FLOAT_SETTING(Y_AXIS), buffer, MSGP_UNIT_MM, true);
        LCDMenu::drawMenuString(LCD_CHAR_MARGIN_LEFT+3*LCD_CHAR_SPACING
                              , 28
                              , 9*LCD_CHAR_SPACING
                              , LCD_CHAR_HEIGHT
    ...
    else if (nr == index++)
    {
        ...
        float_to_string2(FLOAT_SETTING(Z_AXIS), buffer, MSGP_UNIT_MM, true);
        LCDMenu::drawMenuString(LCD_CHAR_MARGIN_LEFT+3*LCD_CHAR_SPACING
                              , 39
                              , 9*LCD_CHAR_SPACING
                              , LCD_CHAR_HEIGHT
...
static void drawPrintSubmenu (uint8_t nr, uint8_t &flags)
{
    ...
    if (printing_page == 1) // second page
    {
        if (nr == index++)
        {
            if (flags & MENU_SELECTED)
            {
                lcd_lib_draw_string_leftP(5, MSGP_GOTO_PAGE_1);
                flags |= MENU_STATUSLINE;
            }
        ...
        else if (nr == index++)
        {
            if (flags & MENU_SELECTED)
            {
                ...
                lcd_lib_draw_stringP(2*LCD_CHAR_MARGIN_LEFT+LCD_CHAR_SPACING, 4, MSGP_CONTROL_OPTIONS);
                flags |= MENU_STATUSLINE;
            }
        ...
        else if (nr == index++)
        {
            if (flags & MENU_SELECTED)
            {
                lcd_lib_draw_string_leftP(5, MSGP_TOGGLE_LED);
                flags |= MENU_STATUSLINE;
            }
        ...
        else if (nr == index++)
        {
            ...
            lcd_lib_draw_string_leftP(15, MSGP_RETRACT);
        ...
        #ifdef PREVENT_FILAMENT_GRIND
            float_to_string2((flags & MENU_ACTIVE) ? retract_length : retract_length_current[active_extruder], buffer, MSGP_UNIT_MM);
        #else
        ...
        else if (nr == index++)
        {
            ...
            lcd_lib_draw_string_leftP(33, MSGP_ACCELERATION_SHORT);
    ...
    else // first page
    {
        ...
        else if (nr == index++)
        {
            if (flags & MENU_SELECTED)
            {
                lcd_lib_draw_string_leftP(5, MSGP_GOTO_PAGE_2);
                flags |= MENU_STATUSLINE;
            }
        ...
        else if (nr == index++)
        {
            ...
            if (flags & (MENU_SELECTED | MENU_ACTIVE))
            {
                ...
                float_to_string1(e_smoothed_speed[0], buffer+5, MSGP_UNIT_FLOW_VOLUME);
    #else
                strcpy_P(buffer, PSTR("Flow(1) "));
                float_to_string1(e_smoothed_speed[0], buffer+8, MSGP_UNIT_FLOW_VOLUME);
    #endif
                lcd_lib_draw_string_left(5, buffer);
                flags |= MENU_STATUSLINE;
            }
        ...
        else if (nr == index++)
        {
            ...
            if (flags & (MENU_SELECTED | MENU_ACTIVE))
            {
                ...
                float_to_string1(e_smoothed_speed[1], buffer+8, MSGP_UNIT_FLOW_VOLUME);
                lcd_lib_draw_string_left(5, buffer);
                flags |= MENU_STATUSLINE;
            }
        ...
        else if (nr == index++)
        {
            ...
            if (flags & (MENU_SELECTED | MENU_ACTIVE))
            {
                ...
                int_to_string(current_nominal_speed+0.5, buffer+6, MSGP_UNIT_SPEED);
                lcd_lib_draw_string_left(5, buffer);
                flags |= MENU_STATUSLINE;
            }
        ...
        else if (nr == index++)
        {
            ...
            int_to_string(float(fanSpeed)*100/255 + 0.5f, buffer, MSGP_UNIT_PERCENT);
            LCDMenu::drawMenuString(LCD_GFX_WIDTH-LCD_CHAR_MARGIN_RIGHT-4*LCD_CHAR_SPACING
    #if TEMP_SENSOR_BED != 0
                                  , 33
    #else
...
void lcd_menu_print_heatup_tg()
{
    ...
    int_to_string(progress*100/124, buffer, MSGP_UNIT_PERCENT);
...
static void drawRecoverSubmenu (uint8_t nr, uint8_t &flags)
{
    ...
    else if (nr == index++)
    {
        ...
        float_to_string2(recover_height, buffer, MSGP_UNIT_MM);
...
{
    float_to_string2((flags & MENU_ACTIVE) ? TARGET_POS(axis) : st_get_position(axis) / axis_steps_per_unit[axis], buffer, MSGP_UNIT_MM);
}
...
static void drawExtrudeSubmenu (uint8_t nr, uint8_t &flags)
{
    ...
    else if (nr == index++)
    {
        ...
        float_to_string2(flags & MENU_ACTIVE ? TARGET_POS(E_AXIS) : st_get_position(E_AXIS) / e_steps_per_unit(active_extruder), buffer, MSGP_UNIT_MM);
